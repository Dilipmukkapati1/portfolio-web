...
import { HOUSEHOLD_TABS, type HouseholdTab } from "./household-section-tabs";
import { cn } from "@/lib/utils";

export type { HouseholdTab };
  ...
  return (
    ...
    >
      <div
        ...
        style={{ gridTemplateColumns: `repeat(${HOUSEHOLD_TABS.length}, minmax(0, 1fr))` }}
      >
        {HOUSEHOLD_TABS.map(({ id, label, icon: Icon }) => {
